...
public class BuildScript
{
	...
	public static void MyBuild()
	{
		...
		var assetBundlePath = Directory.GetParent(path) + @"\AutoBuild";

		// Build and copy AssetBundles.
		BuildScript.BuildAssetBundles();
		BuildScript.CopyAssetBundlesTo(assetBundlePath);
	...
	public static void BuildAssetBundles(BuildAssetBundleOptions buildOptions = BuildAssetBundleOptions.None)
    {
        ...
        //string outputPath = Path.Combine(AssetBundlesOutputPath, BaseLoader.GetPlatformFolderForAssetBundles(EditorUserBuildSettings.activeBuildTarget));
    ...
    public static void BuildPlayer()
    {
	    string buildFolder = @"\AutoBuild";
	    var path = Application.dataPath;
	    var outputPath = Directory.GetParent(path) + @"\AutoBuild";
    ...
    public static void BuildAssetBundlesForAES(BuildAssetBundleOptions buildOptions = BuildAssetBundleOptions.None)
    {
        ...
        for (int i = 0; i < files.Length; i++)
        {
            ...
            // 暗号化符号作成
            string[] s = file.Split('/');
            string cryptoSign = Path.Combine(tmpPath, "____CRYPTO______" + s[s.Length - 1]);
        ...
        string absOutputPath = Path.Combine(AssetBundlesOutputPath, BaseLoader.GetPlatformFolderForAssetBundles(EditorUserBuildSettings.activeBuildTarget));
