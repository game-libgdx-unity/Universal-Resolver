...
namespace UnityIoC.Editor
{
    ...
    public class BindingSettingInspector : BaseInspector
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            var bindingSetting = (BindingSetting) target;
            ...
            var defaultSettingList = bindingSetting.defaultSettings.ToList();
            bindingSetting.defaultSettings = DrawList("Default Setting", "", defaultSettingList,
                data =>
                {
