...
Main purposes:
- --Make your classes independent from each other, they only need to talk to [Context], the main class of this library.
- --Separate your game logic and Unity3d logic into different files. Also Bind your logic to unity3d logic/UI.
- --Abstract your systems, your can use Abstract class or Interfaces for any dependencies in your code.
- --Resolve/Inject dependencies of C# Objects & Unity3d Components in your code.
